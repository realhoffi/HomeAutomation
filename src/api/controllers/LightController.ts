...
class LightController {
  ...
  registerRoutes() {
    ...
    this.router.get(
      "/lights/:id/info/:properties",
      this.getLightProperties.bind(this)
    );
  ...
  getLightProperties(req: express.Request, res: express.Response) {
    return LightServiceInstance.getLightProperties(
      req.app,
      req.params.id,
  ...
  setBrightness(req: express.Request, res: express.Response) {
    return LightServiceInstance.setBrightness(
      req.app,
      req.params.id,
      req.params.value
    )
  ...
  setTemperature(req: express.Request, res: express.Response) {
    return LightServiceInstance.setTemperature(
      req.app,
      req.params.id,
      req.params.value
    )
  ...
  setColor(req: express.Request, res: express.Response) {
    return LightServiceInstance.setColor(
      req.app,
      req.params.id,
      req.params.value
    )
