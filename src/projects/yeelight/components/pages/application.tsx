...
> {
  ...
  constructor(props) {
    ...
    this.colorTemperatureChangedOnLight = this.colorTemperatureChangedOnLight.bind(
      this
    );
  ...
  private colorTemperatureChangedOnLight(
    lightInformation: ILightModel,
    colorTemperature: number
  ) {
    Axios.post(
      "/api/lights/" + lightInformation.id + "/temperature/" + colorTemperature
                    ...
                    <Fragment>
                      ...
                      <Yeelight
                        ...
                        onColorTemperatureChanged={
                          this.colorTemperatureChangedOnLight
                        }
                      />
                    </Fragment>
                  </div>
