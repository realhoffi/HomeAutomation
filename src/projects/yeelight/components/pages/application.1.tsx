...
export class Application extends React.Component<IApplicationProps, IApplicationState> {
    constructor(props) {
        super(props);
        this.state = { gateways: [], lights: [], sensors: [], gatewayLights: [], isInitialized: false };
    ...
    private loadDevices() {
        ...
        return Promise.all([p1, p2, p3])
            .then((results) => {
                ...
                this.setState({ lights: results[0].data["lights"], sensors: results[2].data["sensors"], gateways: gws, gatewayLights: gwLights });
            })
            .catch((error) => { });
    }
