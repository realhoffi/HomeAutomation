...
import { IBaseWeatherSensor } from "../../../models/xiaomi";
...
export class BaseWeatherSensor extends React.Component<IBaseWeatherSensorProps, {}> {
    ...
    render() {
        ...
        return <div className="ms-Grid-row" key={"sensor" + this.props.id}>
            <div className="ms-Grid-col ms-sm12">
                <Panel headerText={this.props.sensorInformations.name} className="custom-padding-bottom-10px" >
                    ...
                    <div className="ms-Grid-row">
                        <div className="ms-Grid-col ms-sm6">
                            <h1 className="ms-font-xl ms-fontColor-themePrimary">
                                ...
                                <i className="ms-Icon ms-Icon--Precipitation" aria-hidden="true"></i>
                            </h1>
                        </div>
                        {
